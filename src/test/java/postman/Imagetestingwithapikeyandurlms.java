...
public class Imagetestingwithapikeyandurlms {
        ...
        try {
            ...
            for (File file : files) {
                ...
                try {
                    ...
                    saveResponseToExcel(sheet, serialNumber, file, formattedJsonResponse, responseTime);
                    serialNumber++;
                } catch (Exception e) {
    ...
    private static void createExcelHeader(Sheet sheet) {
        ...
        headerRow.createCell(5).setCellValue("Response Time (ms)");
    }
    ...
    private static void saveResponseToExcel(Sheet sheet, int serialNumber, File file, String jsonResponse, long responseTime) {
        try {
            ...
            row.createCell(4).setCellValue("Tested"); // Optional status text
            row.createCell(5).setCellValue(responseTime); // Response Time
